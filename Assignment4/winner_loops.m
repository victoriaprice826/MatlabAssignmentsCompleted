...
% Name: Victoria Price
% Date: 9/26/16
% Details: Function checks tic tac toe board for all possibilities of a
% win. Input variables: NumericBoard (hidden board with 0s,1s,2s) and Again
% (prompt to determine if want to play game again).  Output Variables: 
% Updated NumericBoard (hidden board with 0s,1s,2s) and updated Again 
% (prompt to determine if want to play game again). 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
